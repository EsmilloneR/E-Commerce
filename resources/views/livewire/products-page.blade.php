                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" name="" id="featured" class="w-4 h-4 mr-2"
                            ...
                            <li class="mb-4">
                                <label for="sale" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" name="" id="sale" class="w-4 h-4 mr-2"
                                        value="1" wire:model.live="on_sale">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between">
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ Number::currency(1000, 'PHP') }}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ Number::currency(500000, 'PHP') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
